...
class AnimalFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $c1->setLibelle("mammifères")
            ->setDescription("Ce sont des animaux vertébrés nourrissant leurs petits avec du lait");
        $manager->persist($c1);

        $c2 = new Famille();
        $c2->setLibelle("reptiles")
            ->setDescription("Ce sont des animaux vertébrés qui rampent");
        $manager->persist($c2);

        $c3 = new Famille();
        $c3->setLibelle("poissons")
            ->setDescription("Ce sont des animaux invertébrés du monde aquatique");
        $manager->persist($c3);
        ...
        $a4 = new Animal();
        $a4->setNom("Requin")
            ->setDescription("Un animal des fonds marins")
            ->setImage("requin.png")
            ->setPoids(1000)
            ->setDangereux(true)
            ->setFamille($c3)
        ...
        $a5 = new Animal();
        $a5->setNom("Serpent")
            ->setDescription("Un animal rampant")
